...
/*
`
<div class="option"><p>are parallel</p></div>
    <div class="option"><p>are perpendicular</p></div>
    <div class="option"><p>are equal</p></div>
    <div class="option"><p>are undefined</p></div>
`

<div class="avatar"><h2>A</h2></div>
  <div class="bio">
    <h2>Aquila</h2>
    <p><small>category:</small> General Knowledge</p></br>
    <p><small>Difficulty:</small> Hard</p></br>
